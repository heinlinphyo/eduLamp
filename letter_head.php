            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header row ml-1 mr-1">
                                <strong class="card-title text-info"> Letter Head</strong>
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered" style="font-size: 14px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-info"> Letter Head</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $no=1;
                                        $get_logo=mysqli_query($conn,"SELECT * FROM letter_head ");
                    ...
                    <tr>
                        ...
                        <td class=""><img src="admin/letter_head/<?php echo $result_logo['letter_image']; ?> " style="height: 80px;" /></td>
                                  ...
                                  text: 'အချက်အလက်များကို ပယ်ဖျက်လိုက်ပါက ဆုံးရှုံးမှုရှိနိုင်ပါသည်။!',
                                    type: 'warning',
                                        showCancelButton: true,
                                          confirmButtonText: ' <a href="admin/letter_head_del.php?id=<?php echo $result_logo['id']; ?>" class="text-white">သေချာသည်။</a>',
    	...
    	<div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="mediumModalLabel">New Letter Head</h5>
                    ...
                    <div class="modal-body">
                      <form action="admin/letter_head_add.php" method="post" enctype="multipart/form-data">
