                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header row ml-1 mr-1">
                                <strong class="card-title"><i class="fas fa-envelope"></i> SMS </strong>
                                ...
                                <table  class="table table-striped table-bordered table-hover" style="font-size: 12px;">
                                    <thead>
                                        <tr>
                                            <th class="text-info text-right" style="width: 60px;">No</th>
                                             ...
                                             <th class="text-info">Text</th>

                                            
                                            <th class="text-info text-center">Created By</th>
                                            <th class="text-info text-center">Created Date</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle"><?php echo $result_promotion['text_desc'] ?></td>
                                            
                                            
                                       
                                            
                                            <td class="align-middle text-center"><?php echo $result_promotion['user'] ?></td>
                                            <td class="align-middle text-center"><?php echo $result_promotion['reg_date'] ?></td>
