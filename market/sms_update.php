...
<?php include_once "../includes/head.php"; 
	...
	if(isset($_POST['update'])){
		...
		elseif($text_name && $text_desc && $send_type && $send_date && $send_time ){		
				...
				$sql = "UPDATE sms_promotion SET text_name='$text_name', text_desc='$text_desc', send_type='$send_type', send_date='$send_date', send_time='$send_time', user='$user', reg_date='$reg_date'  WHERE id='$id' ";
