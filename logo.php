            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header row ml-1 mr-1">
                                <strong class="card-title text-success"> School Logo</strong>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered" style="font-size: 14px;">
                                    <thead>
                                        <tr>
                                            <th class="text-success text-right" style="width: 40px;">No</th>
                                            <th class="text-success">Logo Image</th>
                                            <th class="text-center text-success" style="width: 100px;">Action</th>
                    ...
                    <tr>
                        ...
                        <td class=""><img src="admin/logo/<?php echo $result_logo['logo_image']; ?> " style="height: 80px;" /></td>
                                  ...
                                  text: 'အချက်အလက်များကို ပယ်ဖျက်လိုက်ပါက ဆုံးရှုံးမှုရှိနိုင်ပါသည်။!',
                                    type: 'warning',
                                        showCancelButton: true,
                                          confirmButtonText: ' <a href="admin/logo_del.php?id=<?php echo $result_logo['id']; ?>" class="text-white">သေချာသည်။</a>',
    	...
    	<div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="mediumModalLabel">New Logo</h5>
                    ...
                    <div class="modal-body">
                      <form action="admin/logo_add.php" method="post" enctype="multipart/form-data">
